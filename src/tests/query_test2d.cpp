...
void QueryTest2D::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("end_test"), &QueryTest2D::end_test);
	...
	// Scoring
	ClassDB::bind_method(D_METHOD("set_multiple_context_score_operator", "score_op"), &QueryTest2D::set_multiple_context_score_operator);
	ClassDB::bind_method(D_METHOD("get_multiple_context_score_operator"), &QueryTest2D::get_multiple_context_score_operator);

	ClassDB::bind_method(D_METHOD("set_scoring_curve", "curve"), &QueryTest2D::set_scoring_curve);
	ClassDB::bind_method(D_METHOD("get_scoring_curve"), &QueryTest2D::get_scoring_curve);

	ClassDB::bind_method(D_METHOD("set_clamp_min_type", "clamp_type"), &QueryTest2D::set_clamp_min_type);
	ClassDB::bind_method(D_METHOD("get_clamp_min_type"), &QueryTest2D::get_clamp_min_type);

	ClassDB::bind_method(D_METHOD("set_score_clamp_min", "score"), &QueryTest2D::set_score_clamp_min);
	ClassDB::bind_method(D_METHOD("get_score_clamp_min"), &QueryTest2D::get_score_clamp_min);

	ClassDB::bind_method(D_METHOD("set_clamp_max_type", "clamp_type"), &QueryTest2D::set_clamp_max_type);
	ClassDB::bind_method(D_METHOD("get_clamp_max_type"), &QueryTest2D::get_clamp_max_type);

	ClassDB::bind_method(D_METHOD("set_score_clamp_max", "score"), &QueryTest2D::set_score_clamp_max);
	ClassDB::bind_method(D_METHOD("get_score_clamp_max"), &QueryTest2D::get_score_clamp_max);
	...
	ClassDB::bind_method(D_METHOD("set_multiple_context_filter_operator", "filter_op"), &QueryTest2D::set_multiple_context_filter_operator);
	ClassDB::bind_method(D_METHOD("get_multiple_context_filter_operator"), &QueryTest2D::get_multiple_context_filter_operator);
...
void QueryTest2D::_notification(int p_what) {
