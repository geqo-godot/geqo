class_name EnvironmentQuery2DTest
...
var environment_query: EnvironmentQuery2D
var grid_generator: GeneratorGridShape2D
...
func before_test() -> void:
	...
	environment_query = auto_free(EnvironmentQuery2D.new())
	grid_generator = auto_free(GeneratorGridShape2D.new())
...
func test_request_query_repeated_request() -> void:
	...
	grid_generator.space_between = 5
...
func test_get_result() -> void:
	...
	var result: QueryResult2D = environment_query.get_result()
